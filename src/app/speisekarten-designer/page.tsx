...
${new Date().toLocaleDateString('de-DE')} • Ihre professionelle Gastronomie-Software
              `;
                              ...
                              try {
                                ...
                                // BETTER FALLBACK: Professional HTML download
                                console.log('Using HTML download for guaranteed PDF capability');
...
<head>
  ...
  <title>${selectedCard.name} - Speisekarte</title>
  <style>
...
<body>
  ...
  <div class="header">
    <h1 class="title">${selectedCard.name}</h1>
  ...
  <div class="footer">
    ...
    <p style="font-size: 0.7rem; margin-top: 10px;">
      ...
      📧 Mehr Profi-Tools: WebMenü, KüchenManager, EAR
                                ...
                                link.href = url;
                                link.download = `${selectedCard.name.replace(/\s+/g, '_')}_Speisekarte.html`;
